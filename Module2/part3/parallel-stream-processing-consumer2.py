# Define dss-employee-parallel-processing topic with two partitions
# bin/kafka-topics.sh --create --topic dss-employee-parallel-processing --bootstrap-server localhost:9092 --partitions 2
